...
=====================================================================================
Script Purpose: This stored procedure performs the ETL process to populate the 'Silver'
...
BEGIN
	...
	RAISE NOTICE 'Procedure started at: %', start_time;
	...
	RAISE NOTICE 'Truncating Table: silver.sales_details';
	...
	RAISE NOTICE 'Finishing procedure...';

	end_time := clock_timestamp();
	RAISE NOTICE 'End time: %', end_time;
	RAISE NOTICE 'Total time taken to load silver layer: %', EXTRACT(EPOCH FROM (end_time - start_time));
